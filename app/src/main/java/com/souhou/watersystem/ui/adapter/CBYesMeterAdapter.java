...
public class CBYesMeterAdapter extends BaseAdapter {
    private List<CBMeterBean.BenYueYiChaoBean> mList;
    private LayoutInflater inflater;
    private Context context;

    public CBYesMeterAdapter(List<CBMeterBean.BenYueYiChaoBean> list, Context context) {
        this.mList = list;
