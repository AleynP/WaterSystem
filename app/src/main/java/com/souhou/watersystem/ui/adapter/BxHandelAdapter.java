...
public class BxHandelAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<BXHandelBean.YiChuLiBaoXiuBean> mList;
    private Context context;

    public BxHandelAdapter(List<BXHandelBean.YiChuLiBaoXiuBean> mList, Context context) {
