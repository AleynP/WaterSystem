...
public class NotHandelBean {


    private List<WeichuLiBaoZhuangBean> WeichuLiBaoZhuang;

    public List<WeichuLiBaoZhuangBean> getWeichuLiBaoZhuang() {
        return WeichuLiBaoZhuang;
    }

    public void setWeichuLiBaoZhuang(List<WeichuLiBaoZhuangBean> WeichuLiBaoZhuang) {
        this.WeichuLiBaoZhuang = WeichuLiBaoZhuang;
    }
